export default {
  async fetch(request, env, ctx) {
    ...
    const BASE_PATH = "/casino-en-ligne"; // on your domain
    ...
    // Build target URL: /casino-en-ligne/foo -> https://casinoguards.com/casino-en-ligne/foo
    ...
    // Rewrite Set-Cookie (Domain=casinoguards.com -> Domain=casino-kit-prod.site)
    ...
    // CSS: sometimes useful to rewrite url(/...) => url(/casino-en-ligne/...)
...
function rewriteAbsoluteToProxy(href, targetOrigin, basePath, reqUrlObj) {
  try {
    ...
    // If link points to source domain — keep as is (path already contains /casino-en-ligne/)
